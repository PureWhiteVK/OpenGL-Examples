...
static void drawAllViews(void) {
  ...
  glMatrixMode(GL_PROJECTION);
  projection = perspective(65.f * (float)M_PI / 180.f, aspect, 1.f, 50.f);
...
int main(void) {
  ...
  if (glbinding::aux::ContextInfo::supported(
          {GLextension::GL_ARB_multisample}) ||
      glbinding::aux::ContextInfo::version() >= glbinding::Version(1, 3)) {
